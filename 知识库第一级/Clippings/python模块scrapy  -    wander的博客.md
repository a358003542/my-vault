---
title: "python模块scrapy  -    wander的博客"
source: "http://localhost:9000/articles/python-module-scrapy.html"
author:
  - "[[wander]]"
published: 2019-09-11
created: 2026-07-17
description: "<div class=\"toc\"><ul><li><a href=\"#简介\">简介</a><ul><li><a href=\"#新建一个项目\">新..."
tags:
  - "clippings"
---
## 简介
...
```
- `user_agent` 属性改变你爬虫情况的USER\_AGENT HTTP头，这通常需要设置一下，防止你的爬虫被ban。
