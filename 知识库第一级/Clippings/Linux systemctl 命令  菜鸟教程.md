---
title: "Linux systemctl 命令 | 菜鸟教程"
source: "https://www.runoob.com/linux/linux-comm-systemctl.html"
author:
published:
created: 2026-07-17
description: "Linux systemctl 命令  Linux 命令大全  什么是 systemctl systemctl 是 Linux 系统中用于控制 systemd 系统和服务管理器的命令行工具。作为现代 Linux 发行版的核心组件，它取代了传统的 init 系统和 service 命令。 systemd 简介 systemd 是一个系统和服务管理器，它：  作为 PID 1 运行（第一个启动的进程） 负责启动、停止和管理其他所有进程 提供.."
tags:
  - "clippings"
---
## Linux systemctl 命令
