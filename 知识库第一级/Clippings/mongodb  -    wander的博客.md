---
title: "mongodb  -    wander的博客"
source: "http://localhost:9000/articles/mongodb.html"
author:
  - "[[wander]]"
published: 2019-09-11
created: 2026-07-17
description: "<div class=\"toc\"><ul><li><a href=\"#简介\">简介</a></li><li><a href=\"#安装\">安装&l..."
tags:
  - "clippings"
---
## 简介
...
具体查找数据有 `find` 和 `find_one` 这两个方法，其中find\_one 是只找一个目标记录（doc），而find则是找到很多。
